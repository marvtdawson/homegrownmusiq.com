...
class Memberz extends Controller
{
    ...
    {
        View::renderTemplate('/memberprofile/bio2.phtml', [
            'tabTitle' => 'Member\'s Bio',
            'pageTitle' => 'Member\'s Bio',
            'siteName' => $this->siteName,
            'siteKeywords' => $this->siteKeywords,
            'pageDescription' => 'Member\'s Bio',
            /*'artistName' =>  $this->artistName,
            'artistMusic' => $this->artistMusic,
            '$artistVideo' => $this->artistVideo,
            'artistBio' => $this->artistBioContent,
    ...
    public function artistmusicAction()
    {
        View::renderTemplate('/memberprofiles/music.phtml', [
            'tabTitle' => 'Member\'s Music',
            'pageTitle' => 'Member\'s Music',
            'siteName' => $this->siteName,
            'siteKeywords' => $this->siteKeywords,
            'pageDescription' => 'Member\'s Music',
            /*'artistName' =>  $this->artistName,
            'artistMusic' => $this->artistMusic,
            '$artistVideo' => $this->artistVideo,
            'artistBio' => $this->artistBioContent,
    ...
    public function artistvideosAction()
    {
        View::renderTemplate('/memberprofiles/videos.phtml', [
            'tabTitle' => 'Member\'s Videos',
            'pageTitle' => 'Member\'s Videos',
            'siteName' => $this->siteName,
            'siteKeywords' => $this->siteKeywords,
            'pageDescription' => 'Member\'s Videos',
            /*'artistName' =>  $this->artistName,
            'artistMusic' => $this->artistMusic,
            '$artistVideo' => $this->artistVideo,
            'artistBio' => $this->artistBioContent,
